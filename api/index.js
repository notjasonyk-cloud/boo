  ...
  fetchProductsFromSellAuth((err, products) => {
    ...
    fs.readFile(templatePath, 'utf8', (err, data) => {
      ...
      const productJson = {
        ...
        meta_image_url: (liveProd.images && liveProd.images.length && (liveProd.images[0].url || liveProd.images[0])) ? (liveProd.images[0].url || liveProd.images[0]) : localAsset.image,
        ...
        image_url: (liveProd.images && liveProd.images.length && (liveProd.images[0].url || liveProd.images[0])) ? (liveProd.images[0].url || liveProd.images[0]) : localAsset.image,
        images: (liveProd.images && liveProd.images.length) ? liveProd.images.map(i => i.url || i) : [localAsset.image],
        image_urls: (liveProd.images && liveProd.images.length) ? liveProd.images.map(i => i.url || i) : [localAsset.image],
        sort_priority: 0,
        deliverables: null,
        stock: -1,
